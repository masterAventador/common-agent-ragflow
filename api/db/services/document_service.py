...
class DocumentService(CommonService):
    ...
    def get_by_kb_id(
        ...
        *,
        ...
        # File2Document and File contributed no selected columns or filters here. Keeping
        # them in the detail query made both valid connector documents and totals depend
        # on unrelated mapping rows. UserCanvas and User are the only display joins.
        docs = (
